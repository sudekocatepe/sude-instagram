...
<<<<<<< HEAD
    <BottomNavigation value={value} onChange={handleChange} showLabels>
      ...
      <BottomNavigationAction label="Login" value="/auth/prihlasenie" icon={<LoginIcon />} />
      <BottomNavigationAction label="Register" value="/auth/registracia" icon={<AppRegistrationIcon />} />
    </BottomNavigation>
=======
